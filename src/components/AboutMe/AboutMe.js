                ...
                <div className="about-me__student">
                    <div className="about-me__bio">
                        ...
                        <p className="about-me__text">
                            Я родился в Омске,  живу в Москеве. Закончил факультет менеджмента РАНХиГС.
                            ...
                            После того, как прошёл курс по веб-разработке, начал делать сайты и веб приложения.
